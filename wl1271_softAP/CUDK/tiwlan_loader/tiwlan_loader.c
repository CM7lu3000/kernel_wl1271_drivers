...
S32 user_main(S32 argc, PPS8 argv)
{
    S32 i;
#if 1
    PS8 eeprom_file_name = (PS8)"/system/etc/wifi/softap/nvs_map.bin";
    PS8 init_file_name = (PS8)"/system/etc/wifi/softap/tiwlan_ap.ini";
    PS8 firmware_file_name = (PS8)"/system/etc/wifi/softap/firmware_ap.bin";
#else
